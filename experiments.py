    ...
    for i in range(len(selected)):
        ...
        for j in range(len(f_set)):
            ...
            for k in range(len(r_set)):
                ...
                mapper = trav.TraversabilityEstimator(tf=f, r=r, overlap=True)
                ...
                for ii in range(len(c_set)):
                    ...
                    keypoints = graphmapx.get_keypoints_overlap(positive_keypoints, grid)
                    combinations = list(itertools.combinations(keypoints, 2))
                    ...
                    keypoints = graphmapx.get_keypoints_overlap(negative_keypoints, grid)
                    combinations = list(itertools.combinations(keypoints, 2))
